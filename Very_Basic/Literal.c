...
int main()
{
	...
	printf("%d\n",'ABCD');
	// When we assign a multi-character to char variable it will assign only the first(from right) 8 bits(1 byte) to the char variable (as sizeof char is 1 byte),
	// means the last character of multi-character will be assigned to the character variable .
