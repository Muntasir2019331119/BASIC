...
{
    int x = 2, y = 5;
    (x & y) ? printf("True ") : printf("False ");//0
    (x && y) ? printf("True ") : printf("False ");//1
    return 0;
}
...
False True
	...
	int c,d;
	char e,f;
	printf("%d %d %d\n",sizeof(a&&b),sizeof(c&&d),sizeof(e&&f));//4 4 4
	
	printf("%d %d %d\n",sizeof(a&b),sizeof(c&d),sizeof(e&f)); //8 4 4 // char  e and  f is promoted to int .
