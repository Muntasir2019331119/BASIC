...
int main()
{
	...
	//y=4 byte,d=5bit,m=4 bit..so sum=4byte+(5+4bit)=5 byte 1 bit..so it crossed 4 byte..in structure size is the multiple of highest size..it crossed 4..so size is 8.
	//.if it crossed 8..then the size will be 12..
